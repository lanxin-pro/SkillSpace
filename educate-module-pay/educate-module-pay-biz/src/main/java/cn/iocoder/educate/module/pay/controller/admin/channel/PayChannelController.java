package cn.iocoder.educate.module.pay.controller.admin.channel;
...
public class PayChannelController {
    ...
    @PreAuthorize("@lanxin.hasPermission('pay:channel:query')")
    ...
    public CommonResult<Set<String>> getEnableChannelCodeList(@RequestParam("appId") Long appId) {
        ...
        Set<String> collect = channels.stream().map(PayChannelDO::getCode)
