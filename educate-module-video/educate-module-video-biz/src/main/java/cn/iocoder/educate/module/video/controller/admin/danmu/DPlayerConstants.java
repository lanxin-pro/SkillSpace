...
public class DPlayerConstants {
    ...
    public static final String DPLAYER_BARRAGE_TIME = "1.236";
    public static final String DPLAYER_BARRAGE_TEXT = "你说我的弹幕到底在哪里？？？？";
    public static final String DPLAYER_BARRAGE_COLOR = "15024726";
    public static final String DPLAYER_BARRAGE_TYPE = "1";
