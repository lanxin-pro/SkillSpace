...
import { getNotifyTemplate,createNotifyTemplate,updateNotifyTemplate } from '@/api/system/notify/template/index.js'
...
const submitForm = async () => {
  ...
  try {
    ...
    if (formType.value === 'create') {
      await createNotifyTemplate(data)
      ElComponent.msgSuccess('新增成功')
    } else {
      await updateNotifyTemplate(data)
