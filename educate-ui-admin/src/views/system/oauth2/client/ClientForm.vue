<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle" max-height="500px">
    <el-form
        ref="formRef"
...
import { createOAuth2Client,updateOAuth2Client,getOAuth2Client } from '@/api/system/oauth2/client/index.js'
...
const open = async (type, id) => {
  ...
  if (id) {
    ...
    try {
      const response = await getOAuth2Client(id)
