      ...
      <el-col v-if="statisticsData" v-bind="grid">
        <div class="pl25">
          <div class="toDay">
            ...
            >日环比：
              <i :class="Number(statisticsData.right.today.series[0].rate) >= 0 ? 'up' : 'down'" class="content-is"
            ...
            <span class="toDay-time spBlock"
            >月环比：
              <i :class="Number(statisticsData.right.month[0].rate) >= 0 ? 'up' : 'down'" class="content-is"
          ...
          <div class="toDay" style="border: none">
            ...
            <span class="toDay-time spBlock"
            >日环比：
              <i :class="Number(statisticsData.right.today.series[1].rate) >= 0 ? 'up' : 'down'" class="content-is"
            ...
            <span class="toDay-time spBlock"
            >月环比：
              <i :class="Number(statisticsData.right.month[1].rate) >= 0 ? 'up' : 'down'" class="content-is"
...
<script>
import echartsNew from '@/components/echartsNew/index.vue';
      ...
      statisticsData: {
        right: {
          today: {
            series: [
              {
                now_money: 1000, // 设置默认值为 1000，你可以替换为实际值
                last_money: 2000,
              },
              {
                now_money: 1000, // 设置默认值为 1000，你可以替换为实际值
