<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="800" dialogEnableStatus="true">
    <el-form
        ref="formRef"
        :model="formData"
        :rules="formRules"
...
import { getLevel,createLevel,updateLevel } from '@/api/member/level/index.js'
