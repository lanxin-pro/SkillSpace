package cn.iocoder.educate.ssodemo.framework.filter;

import cn.iocoder.educate.ssodemo.client.OAuth2Client;
import cn.iocoder.educate.ssodemo.client.dto.CommonResult;
import cn.iocoder.educate.ssodemo.client.dto.oauth2.OAuth2CheckTokenRespDTO;
import cn.iocoder.educate.ssodemo.framework.LoginUser;
import cn.iocoder.educate.ssodemo.framework.core.util.SecurityUtils;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * 校验token
     * @param token 从请求头里面substring后的token
     * @return null 没有拿到token
     */
