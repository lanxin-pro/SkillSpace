package cn.iocoder.educate.module.mp.service.message.bo;
...
public class MpMessageSendOutReqBO {
     ...
     */
    @NotEmpty(message = "消息 mediaId 不能为空", groups = {MpUtils.ImageMessageGroup.class, MpUtils.VoiceMessageGroup.class,
