package cn.iocoder.educate.module.mp.controller.admin.tag;

import cn.iocoder.educate.framework.common.pojo.CommonResult;
import cn.iocoder.educate.framework.common.pojo.PageResult;
import cn.iocoder.educate.module.mp.controller.admin.tag.vo.*;
...
import cn.iocoder.educate.module.mp.service.tag.MpTagService;
...
public class MpTagController {
    ...
    @PreAuthorize("@lanxin.hasPermission('mp:tag:create')")
    ...
    @PreAuthorize("@lanxin.hasPermission('mp:tag:update')")
    ...
    @PreAuthorize("@lanxin.hasPermission('mp:tag:delete')")
    ...
    @PreAuthorize("@lanxin.hasPermission('mp:tag:query')")
    ...
    @PreAuthorize("@lanxin.hasPermission('mp:tag:sync')")
