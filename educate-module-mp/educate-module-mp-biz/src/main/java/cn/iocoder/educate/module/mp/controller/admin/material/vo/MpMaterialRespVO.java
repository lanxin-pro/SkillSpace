package cn.iocoder.educate.module.mp.controller.admin.material.vo;
...
public class MpMaterialRespVO {
    ...
    @Schema(description = "文件类型 参见 WxConsts.MediaFileType 枚举", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "image")
    private String type;
    ...
    @Schema(description = "素材的 URL", requiredMode = Schema.RequiredMode.REQUIRED,
