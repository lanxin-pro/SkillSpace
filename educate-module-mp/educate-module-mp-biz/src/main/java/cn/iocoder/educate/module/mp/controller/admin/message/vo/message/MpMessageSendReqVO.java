package cn.iocoder.educate.module.mp.controller.admin.message.vo.message;
...
public class MpMessageSendReqVO {
    ...
    @NotEmpty(message = "消息内容不能为空", groups = {MpUtils.ImageMessageGroup.class, MpUtils.VoiceMessageGroup.class,
            MpUtils.VideoMessageGroup.class})
