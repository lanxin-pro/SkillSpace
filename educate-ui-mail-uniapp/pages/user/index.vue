	...
	<view class="app-container">
      ...
      <view class="promotion">
        <view class="membership-interest">
          ...
          <view class="open-channels">
            立即开通
            <text class='ml20 iconfont icon-xiangyou' />
          </view>

        </view>
      </view>
		</view>
    <view class="member-formal-content">
      <view class="category">
