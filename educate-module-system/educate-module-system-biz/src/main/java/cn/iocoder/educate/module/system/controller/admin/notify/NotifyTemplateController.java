...
import cn.iocoder.educate.module.system.controller.admin.notify.vo.template.*;
...
import cn.iocoder.educate.module.system.service.notify.NotifySendService;
...
public class NotifyTemplateController {
    ...
    @PreAuthorize("@lanxin.hasPermission('system:notify-template:create')")
    ...
    @PreAuthorize("@lanxin.hasPermission('system:notify-template:update')")
    ...
    @PreAuthorize("@lanxin.hasPermission('system:notify-template:delete')")
    ...
    @PreAuthorize("@lanxin.hasPermission('system:notify-template:query')")
