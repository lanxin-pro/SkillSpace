package cn.iocoder.educate.module.system.controller.admin.oauth2.vo.open;
...
public class OAuth2OpenCheckTokenRespVO {
    ...
    @Schema(description = "过期时间,时间戳 / 1000，即单位：秒", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "1593092157")
    private Long exp;
