...
public class MemberLevelBaseVO {
    ...
    @Schema(description = "等级名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "蓝欣")
    ...
    @Schema(description = "等级图标", example = "https://www.alanxin.cn/yudao.jpg")
    @URL(message = "等级图标必须是 URL 格式")
    private String icon;

    @Schema(description = "等级背景图", example = "https://www.alanxin.cn/yudao.jpg")
