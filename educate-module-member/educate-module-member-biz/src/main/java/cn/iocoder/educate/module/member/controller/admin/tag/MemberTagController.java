package cn.iocoder.educate.module.member.controller.admin.tag;
...
public class MemberTagController {
    ...
    @PreAuthorize("@lanxin.hasPermission('member:tag:create')")
    ...
    @PreAuthorize("@lanxin.hasPermission('member:tag:update')")
    ...
    @PreAuthorize("@lanxin.hasPermission('member:tag:delete')")
    ...
    @PreAuthorize("@lanxin.hasPermission('member:tag:query')")
