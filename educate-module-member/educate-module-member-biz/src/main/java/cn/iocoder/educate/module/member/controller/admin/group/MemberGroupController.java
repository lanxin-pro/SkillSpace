package cn.iocoder.educate.module.member.controller.admin.group;

import cn.iocoder.educate.framework.common.pojo.CommonResult;
import cn.iocoder.educate.framework.common.pojo.PageResult;
import cn.iocoder.educate.module.member.controller.admin.group.vo.*;
...
public class MemberGroupController {
    ...
    @PreAuthorize("@lanxin.hasPermission('member:group:create')")
    ...
    @PreAuthorize("@lanxin.hasPermission('member:group:update')")
    ...
    @PreAuthorize("@lanxin.hasPermission('member:group:delete')")
    ...
    @PreAuthorize("@lanxin.hasPermission('member:group:query')")
