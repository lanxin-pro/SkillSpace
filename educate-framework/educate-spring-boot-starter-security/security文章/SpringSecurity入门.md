...
和 [「2.1 引入依赖」](https://www.iocoder.cn/Spring-Boot/Spring-Security/?yudao#) 一致，见 [`pom.xml`](https://github.com/YunaiV/SpringBoot-Labs/blob/master/lab-01-spring-security/lab-01-springsecurity-demo-role/pom.xml) 文件。
